...
bronze_measurements_schema = StructType(
    [
        ...
        StructField(
            BronzeMeasurementsColumnNames.orchestration_instance_id, StringType(), True
        ),
        StructField(
            BronzeMeasurementsColumnNames.metering_point_id, StringType(), True
        ),
        ...
        StructField(
            BronzeMeasurementsColumnNames.metering_point_type, StringType(), True
        ),
        ...
        StructField(
            BronzeMeasurementsColumnNames.start_datetime, TimestampType(), True
        ),
