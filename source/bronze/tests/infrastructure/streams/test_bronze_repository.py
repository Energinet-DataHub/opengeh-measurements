...
def test__read_measurements__should_read_from_bronze_measurements_table(spark: SparkSession, migrate):
    # Arrange
...
def test__read_submitted_transactions__should_read_from_bronze_measurements_table(spark: SparkSession, migrate):
    # Arrange
    bronze_repository = BronzeRepository(spark)
