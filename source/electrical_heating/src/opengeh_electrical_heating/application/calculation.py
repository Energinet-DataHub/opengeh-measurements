...
from opengeh_calculated_measurements.opengeh_electrical_heating.application.job_args.electrical_heating_job_args import (
    parse_command_line_arguments,
    parse_job_arguments,
)
from opengeh_calculated_measurements.opengeh_electrical_heating.domain import (
    CalculationOutput,
    ColumnNames,
...
def _execute_application(spark: SparkSession, args: ElectricalHeatingArgs) -> None:
    ...
    electrical_heating_internal_repository = ElectricalHeatingInternalRepository(
        spark, args.catalog_name
    )
    ...
    electrical_heating_internal_repository.save(
