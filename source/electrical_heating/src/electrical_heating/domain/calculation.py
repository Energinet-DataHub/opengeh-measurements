...
def execute_core_logic(
    ...
    metering_point_periods = _join_child_to_parent_metering_point(
    ...
    consumption = _filter_parent_child_overlap_period_and_year(
        consumption_with_metering_point_periods
    )
