...
from geh_calculated_measurements.measurements_report.application.measurement_report_args import (
...
# cenc
def execute() -> None:
    measurement_report_args = MeasurementsReportArgs()  # Retrieve calculation oriented settings / job arguments
    logging_settings = configure_logging(subsystem="measurements", cloud_role_name="dbr-net-consumption-group-6")
    orchestrate_business_logic(measurement_report_args, logging_settings=logging_settings)
