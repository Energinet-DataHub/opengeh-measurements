...
from geh_calculated_measurements.database_migrations.database_definitions import DatabaseMigrationsDatabaseDefinition
...
def _configure_spark_sql_migrations() -> SparkSqlMigrationsConfiguration:
    ...
    return SparkSqlMigrationsConfiguration(
        migration_schema_name=DatabaseMigrationsDatabaseDefinition.measurements_calculated_internal_database,
        migration_table_name=DatabaseMigrationsDatabaseDefinition.executed_migrations_table_name,
