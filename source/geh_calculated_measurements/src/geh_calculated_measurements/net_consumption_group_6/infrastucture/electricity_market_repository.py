...
class ElectricityMarketRepository:
    ...
    def read_net_consumption_group_6_consumption_metering_point_periods(self) -> ConsumptionMeteringPointPeriods:
        table_name = f"{self._catalog_name}.{net_consumption_group_6_consumption_metering_point_periods_v1.database_name}.{net_consumption_group_6_consumption_metering_point_periods_v1.view_name}"
    ...
    def read_net_consumption_group_6_child_metering_points(self) -> ChildMeteringPoints:
        table_name = f"{self._catalog_name}.{net_consumption_group_6_child_metering_points_v1.database_name}.{net_consumption_group_6_child_metering_points_v1.view_name}"
