...
class Repository:
    def __init__(
        self,
        spark: SparkSession,
        electricity_market_data_path: str | None = None,
    ) -> None:
        self._spark = spark
    ...
    def read_net_consumption_group_6_consumption_metering_point_periods(self) -> ConsumptionMeteringPointPeriods:
        table_name = f"{self._electricity_market_data_path}.{ElectricityMarketMeasurementsInputDatabaseDefinition.DATABASE_NAME}.{ElectricityMarketMeasurementsInputDatabaseDefinition.NET_CONSUMPTION_GROUP_6_CONSUMPTION_METERING_POINT_PERIODS}"
    ...
    def read_net_consumption_group_6_child_metering_point_periods(self) -> ChildMeteringPoints:
        table_name = f"{self._electricity_market_data_path}.{ElectricityMarketMeasurementsInputDatabaseDefinition.DATABASE_NAME}.{ElectricityMarketMeasurementsInputDatabaseDefinition.NET_CONSUMPTION_GROUP_6_CHILD_METERING_POINT}"
