...
def calculate_daily(
    ...
    print(execution_start_datetime)
    ...
    print("cenc_added_col")
    cenc_added_col.show()

    cenc_selected_col = cenc_added_col.select(  # selecting needed columns
        F.make_date(F.col("settlement_year"), F.col("settlement_month"), F.lit(1)).alias("settlement_date"),
    ...
    print("latest_measurements_date")
