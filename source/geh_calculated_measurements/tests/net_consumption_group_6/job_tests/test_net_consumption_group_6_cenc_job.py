...
from geh_calculated_measurements.net_consumption_group_6.entry_point import execute_cenc
...
def test_execute(
    ...
    monkeypatch.setattr(os, "environ", create_job_environment_variables(cnc_get_test_files_folder_path()))
