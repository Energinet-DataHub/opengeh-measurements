...
from silver.domain.transform import transform
from silver.infrastructure.services.spark_initializer import initialize_spark
...
def _execute(spark: SparkSession) -> None:
    ...
    silver_repository = measurements_silver_repository.Repository(transform)
