...
from core.gold.domain.transformations.receipts_transformation import transform as transform_to_receipts
...
def _batch_operation(silver_measurements: DataFrame, batch_id: int) -> None:
    ...
    receipts = transform_to_receipts(gold_measurements)
