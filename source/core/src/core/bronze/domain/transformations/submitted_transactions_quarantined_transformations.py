...
def map_silver_measurements_to_submitted_transactions_quarantined(silver_measurements: DataFrame) -> DataFrame:
    return silver_measurements.select(
        ...
        col(SubmittedTransactionsQuarantinedColumnNames.validate_metering_point_type),
        col(SubmittedTransactionsQuarantinedColumnNames.validate_resolution),
        col(SubmittedTransactionsQuarantinedColumnNames.validate_unit),
        col(SubmittedTransactionsQuarantinedColumnNames.validate_quality),
        col(SubmittedTransactionsQuarantinedColumnNames.validate_orchestration_type),
    )
