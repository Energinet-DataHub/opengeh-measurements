...
SET metering_point_type = CASE
        ...
        WHEN metering_point_type == 'D09' THEN 'MPT_OWN_PRODUCTION'
        ...
        WHEN metering_point_type == 'D19' THEN 'MPT_CAPACITY_SETTLEMENT'
        WHEN metering_point_type == 'D20' THEN 'MPT_EXCHANGE_REACTIVE_ENERGY'
        WHEN metering_point_type == 'D21' THEN 'MPT_COLLECTIVE_NET_PRODUCTION'
        WHEN metering_point_type == 'D22' THEN 'MPT_COLLECTIVE_NET_CONSUMPTION'
        WHEN metering_point_type == 'D99' THEN 'MPT_INTERNAL_USE'
