...
scenarios("../features/gold_current_sap_view.feature")
...
@when(
    "querying the current_sap_v1 gold view for that metering point and quantity is null",
...
@when("querying the current_sap_v1 gold view for that metering point", target_fixture="actual_result")
...
@when(
    "querying the current_sap_v1 gold view for that metering point and expected quantity",
