Feature: Transmission of measurements
  ...
  Scenario: Measurement transaction delivered to Gold Layer and SAP Series Gold Table
    Then the measurement transaction is available in the Gold Layer
    And the measurement transaction is available in the SAP Series Gold table
