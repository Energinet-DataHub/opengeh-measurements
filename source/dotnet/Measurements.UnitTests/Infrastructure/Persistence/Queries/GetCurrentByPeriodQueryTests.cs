...
[UnitTest]
public class GetCurrentByPeriodQueryTests
{
    [Theory]
    [AutoData]
    public void ToString_Returns_ExpectedResult(string meteringPointId, Instant startDate, Instant endDate)
    {
        ...
        var getCurrentByPeriodQuery = new GetCurrentByPeriodQuery(meteringPointId, startDate, endDate, databricksSchemaOptions);

        // Act
        var result = getCurrentByPeriodQuery.ToString();
