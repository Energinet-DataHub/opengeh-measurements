...
[UnitTest]
public class MeasurementsAggregatedByYearResponseV4Tests
{
    [Fact]
    public void Create_WhenValidInput_ThenExpectedResultIsReturned()
    {
        ...
        // Act
        var actual = MeasurementsAggregatedByYearResponseV4.Create(aggregatedMeasurements)!;
    ...
    public void Create_WhenDataContainsInvalidQualities_ThenThrowException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentOutOfRangeException>(() => MeasurementsAggregatedByYearResponseV4.Create(aggregatedMeasurements)!);
    }
