...
public interface IMeasurementsClient
{
    ...
    /// </summary>
    Task<IEnumerable<MeasurementAggregationByMonthDto>> GetYearlyAggregateByMonth(GetYearlyAggregateByMonthsQuery query, CancellationToken cancellationToken = default);
}
