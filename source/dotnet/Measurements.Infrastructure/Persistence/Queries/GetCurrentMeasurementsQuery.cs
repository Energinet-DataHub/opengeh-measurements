...
public class GetCurrentMeasurementsQuery : DatabricksStatement
{
    ...
    public GetCurrentMeasurementsQuery(string meteringPointId, Instant startDate, Instant endDate, DatabricksSchemaOptions databricksSchemaOptions)
    {
