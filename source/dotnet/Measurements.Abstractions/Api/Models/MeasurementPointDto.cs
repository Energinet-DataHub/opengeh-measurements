...
/// </summary>
/// <param name="Order">Order of priority. Order of 1 is the current value. 2+ is historical values.</param>
...
public sealed record MeasurementPointDto(int Order, decimal Quantity, Quality Quality, Unit Unit, DateTimeOffset Created);
