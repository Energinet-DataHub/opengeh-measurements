...
/// <param name="MissingValues">Indicates if aggregate contains missing values during day of aggregation.</param>
/// <param name="ContainsUpdatedValues">Indicates if measurements in aggregate has been updated since creation.</param>
