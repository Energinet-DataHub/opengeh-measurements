...
/// <param name="ContainsMissingValues">Indicates whether aggregate contains missing values during day of aggregation.</param>
/// <param name="ContainsUpdatedValues">Indicates whether any measurements in aggregate has been updated since creation.</param>
public sealed record MeasurementAggregationByDateDto(DateOnly Date, decimal? Quantity, Quality Quality, Unit Unit, bool ContainsMissingValues, bool ContainsUpdatedValues);
